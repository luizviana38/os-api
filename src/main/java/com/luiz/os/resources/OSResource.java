...
import com.luiz.os.services.OSService;
@CrossOrigin("*")
@RestController
...
public class OSResource {
	...
	public ResponseEntity<OSDTO> create(@Valid @RequestBody OSDTO obj) {
		...
		URI uri = ServletUriComponentsBuilder.fromCurrentRequest().path("/{ii}").buildAndExpand(obj.getId()).toUri();
